...
public class MemoryCacheSegmentRetiringTask extends PoolItemRetiringTask{
	public static final String CLASS_NAME = MemoryCacheSegmentRetiringTask.class.getName();
	public static final String PACKAGE_NAME = CLASS_NAME.substring(0, CLASS_NAME.lastIndexOf("."));
	public static Logger sLogger = LogManager.getLogger(PACKAGE_NAME);
	
	protected MemoryCacheSegmentRetiringTask(IPool pPool, SteppedThrottledAppThread pSteppedThrottledAppThread,
