...
public class CompressableCacheSegmentInitializationThread extends PoolItemInitializationThread {
	...
	protected CompressableCacheSegmentInitializationThread(IPool pPool, String pPoolItemId, CompressableCacheSegmentOperationsTask pPoolItemOperationsTask,
			String pLogContext) {
	...
	protected CompressableCacheSegmentInitializationThread(IPool pPool, CompressableCacheSegmentPoolItemIndexEntry pPoolItem, String pLogContext) {
		super(pPool, pLogContext, true);
		if (ApplicationPrecompilerSettings.TRACE_LOGACTIVE) {
			sLogger.trace(ApplicationPrecompilerSettings.TRACE_ENTERING);
		}
