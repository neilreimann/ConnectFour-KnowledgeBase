...
public abstract class PoolItemTerminatingThread extends PersistentAppThread {
	public static final String CLASS_NAME = PoolItemTerminatingThread.class.getName();
	...
	public PoolItemTerminatingThread(IPool pPool, String pLogContext, int pMaxThrottleCount, int pThrottleWaitMs) {
